...
namespace monitaal {
    ...
    struct symbolic_state_map_t {
        ...
        [[nodiscard]] typename std::map<location_id_t, state_t>::iterator begin();
        [[nodiscard]] typename std::map<location_id_t, state_t>::const_iterator begin() const;

        [[nodiscard]] typename std::map<location_id_t, state_t>::iterator end();
        [[nodiscard]] typename std::map<location_id_t, state_t>::const_iterator end() const;
