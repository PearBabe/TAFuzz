...
def main() -> int:
    ...
    parser.add_argument("--capture-id", default="PX4-M6-MC-NONE-IRIS-I42-20260718")
    ...
    for msgid, cls in sorted(module.mavlink_map.items()):
        name = getattr(cls, "msgname", getattr(cls, "name", f"MSG_{msgid}"))
...
- Vehicle/profile: `px4_sitl_default`, multicopter `none_iris`, headless, instance {INSTANCE}
...
""" + "\n".join(f"- {item}" for item in limitations) + "\n"
    ...
    manifest = {
        ...
        "captures": [{
            ...
            "system": "PX4",
            "vehicle": "multicopter",
            "profile": f"px4_sitl_default none_iris headless instance {INSTANCE}",
            "firmware_commit": FIRMWARE_COMMIT,
            "mavlink_commit": MAVLINK_COMMIT,
            "runtime_status": runtime_status,
