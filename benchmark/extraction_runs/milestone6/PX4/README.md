...
Status: **COMPLETE**. This is an observation artifact only; implementation satisfaction is **NOT_ASSESSED**.
...
- Vehicle/profile: `px4_sitl_default`, internal headless multicopter `sihsim_quadx`, instance 42
...
- Observed autopilot SYSID/COMPID: `43:1`
...
- MAVLink messages: 14748 across 54 distinct ID/name pairs.
- Baseline distinct messages: 33.
- PARAM snapshot: COMPLETE; expected 900, unique indices 900, unique names 901, missing indices 0.
- Required named parameters observed: 18/18.
- Request sweep: COMPLETE; attempted 243/243, matching message observed for 47, unsupported ACK for 0, no ACK/no matching frame for 0.
- PX4 exit code: 0; isolated process cleanup: True.
