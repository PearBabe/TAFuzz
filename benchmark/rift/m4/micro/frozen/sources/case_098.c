/*
 * Opaque RIFT-M4 synthetic input case_098.
...
static void commit_if_ready(struct NeutralContext *context, int value) {
    ...
    int main(int argc, char **argv) {
        /* public declaration */
        int v_ce9bf2d8468f = read_arg(argc, argv, 1, 8);
        /* public declaration */
        struct NeutralContext v_d8bdd3cf55 = {0, 0, 0};
        commit_if_ready(&v_d8bdd3cf55, v_ce9bf2d8468f);
        initialize_context(&v_d8bdd3cf55);
        select_mode(&v_d8bdd3cf55, 2);
        v_d8bdd3cf55.state = 8;
        /* public declaration */
        int v_f5dc52ac = v_d8bdd3cf55.state;
        /* public property declaration */
        int ap_primary = (v_f5dc52ac == 8);
        printf("AP_primary=%d\n", ap_primary);
        return 0;
    }
