/*
 * Opaque RIFT-M4 synthetic input case_113.
...
static void commit_callback(int payload, int *state) { *state = payload; }
    ...
    int main(int argc, char **argv) {
        /* public declaration */
        int v_72704042931e = read_arg(argc, argv, 1, 6);
        /* public declaration */
        struct NeutralQueue v_5708cc9d = {0, 0};
        (void)enqueue_value(&v_5708cc9d, v_72704042931e, 0);
        /* public declaration */
        int v_9f4180537dc = dequeue_value(&v_5708cc9d);
        (void)v_9f4180537dc;
        /* public declaration */
        struct NeutralTimer v_dcd03dc2 = {1, 0};
        int state = 0;
        if (fire_timer(&v_dcd03dc2)) {
            commit_callback(6, &state);
        }
        /* public declaration */
        int v_9387d220fa6223861 = state;
        /* public property declaration */
        int ap_primary = (v_9387d220fa6223861 >= 6);
        printf("AP_primary=%d\n", ap_primary);
        return 0;
    }
