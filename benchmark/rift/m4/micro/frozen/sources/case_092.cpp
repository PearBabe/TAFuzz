/*
 * Opaque RIFT-M4 synthetic input case_092.
...
static void commit_if_ready(struct NeutralContext *context, int value) {
    ...
    int main(int argc, char **argv) {
        /* public declaration */
        int v_99de07db26c0 = read_arg(argc, argv, 1, 8);
        /* public declaration */
        struct NeutralContext v_7e675f97be = {0, 0, 0};
        commit_if_ready(&v_7e675f97be, v_99de07db26c0);
        initialize_context(&v_7e675f97be);
        select_mode(&v_7e675f97be, 2);
        v_7e675f97be.state = 8;
        /* public declaration */
        int v_5ed15fb0 = v_7e675f97be.state;
        /* public property declaration */
        int ap_primary = (v_5ed15fb0 == 8);
        printf("AP_primary=%d\n", ap_primary);
        return 0;
    }
