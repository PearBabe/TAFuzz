/*
 * RIFT-GOLD-087: timing_drop_repeat_reorder, variant 6, MAY_INFLUENCE
...
struct NeutralTimeline { int delay; int delivered; int repeats; int order; };
    ...
    int main(int argc, char **argv) {
        ...
        int source_primary = read_arg(argc, argv, 1, 2);
        ...
        node_timeline.repeats = source_sequence_gate ? source_primary : 2;
        /* RIFT_NODE:node_event_value */
        int node_event_value = node_timeline.repeats;
        /* RIFT_AP:ap_primary */
        int ap_primary = (node_event_value >= 2);
        printf("AP_primary=%d\n", ap_primary);
        return 0;
    }
