/*
 * RIFT-GOLD-048: config_threshold, variant 7, NO_INFLUENCE
...
int main(int argc, char **argv) {
    ...
    int source_configuration = read_arg(argc, argv, 1, 17);
    (void)source_configuration;
    /* RIFT_SOURCE:source_observation */
    int source_observation = read_arg(argc, argv, 2, 17);
    /* RIFT_NODE:node_threshold */
    int node_threshold = 17;
