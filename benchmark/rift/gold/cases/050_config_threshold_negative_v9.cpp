/*
 * RIFT-GOLD-050: config_threshold, variant 9, NO_INFLUENCE
...
int main(int argc, char **argv) {
    ...
    int source_configuration = read_arg(argc, argv, 1, 19);
    (void)source_configuration;
    /* RIFT_SOURCE:source_observation */
    int source_observation = read_arg(argc, argv, 2, 19);
    /* RIFT_NODE:node_threshold */
    int node_threshold = 19;
