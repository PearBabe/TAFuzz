/*
 * RIFT-GOLD-047: config_threshold, variant 6, MAY_INFLUENCE
...
int main(int argc, char **argv) {
    ...
    int source_configuration = read_arg(argc, argv, 1, 16);
    /* RIFT_SOURCE:source_observation */
    int source_observation = read_arg(argc, argv, 2, 16);
    /* RIFT_SOURCE:source_gate */
    int source_gate = read_arg(argc, argv, 3, 1);
    /* RIFT_NODE:node_threshold */
    int node_threshold = source_gate ? source_configuration : 16;
